...
type EBookRatingProps = {
  toggleRatingShow: (isShow: boolean) => void
}

import ChooseRating from './ChooseRating'

export default function EBookRating({ toggleRatingShow }: EBookRatingProps) {
        ...
        <div className={EBCSS.groupChoose}>
          ...
          <div className={EBCSS.groupConfirm}>
            ...
            <button
              ...
              onClick={() => {
                if (handler.isPreference || studyInfo.isSubmitPreference) {
                  handler.clearGoStoryState()
                  handler.goStudy()
                } else {
                  doPreference()
