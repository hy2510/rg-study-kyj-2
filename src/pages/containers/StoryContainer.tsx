...
import EBookRating from '@components/story/EBookRating'
...
export default function EBook() {
   ...
   * @param isShow
   */
  const toggleRatingShow = (isShow: boolean) => {
    setRatingShow(isShow)
  }
  ...
  return (
    <>
      ...
      {/* rating */}
      {isRatingShow && <EBookRating toggleRatingShow={toggleRatingShow} />}
